...
import { RefreshCw, Trophy, Archive, Database, ArrowRight, ArrowLeft, Play } from 'lucide-react';
        ...
        <div className="flex items-center gap-3">
          {step === 'lineup' && (
            <button 
                ...
                className="flex items-center gap-2 px-5 py-1.5 rounded bg-green-600 hover:bg-green-700 text-white font-bold shadow transition-all animate-pulse"
            >
